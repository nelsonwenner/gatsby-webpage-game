...
const About = () => {
  return (
    <Wrapper id="about">
      <Container>
        <Title className="anime-section anime-left-15">About</Title>
        <Row>
          <Column>
          ...
          <Column>
            <TextWrapper className="anime-section anime-right-15">
              <Sinopse>
                Sinopse
                <Pipe></Pipe>
              </Sinopse>
              <Text>
                ...
                with various information from history. With all this
                information, an artificial intelligence, which was designed with
                a level of functioning very similar to that of a human brain -
                ...
                crowns on more people, thus forming a provisional army of
                humans. When this army reached an ideal size, artificial
                intelligence tried to cause a virus to be produced as a
                biological weapon, which turns humans into undead thirsty for
                the flesh of uninfected humans, and which can transmit the virus
                from of bites.
                <br />
                <br />
                One of the few population defense groups left over the world has
                devised an invasion plan for the base where artificial
                intelligence is located to destroy it and find the vaccine and
                spread it to the remaining population so that it remains immune
                to the virus. The best agent in this group was in charge of
                trying to carry out this mission, having to face both undead and
                snipers controlled by the synaptic crown.
              </Text>
            </TextWrapper>
          </Column>
        </Row>
